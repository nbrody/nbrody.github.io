...
function buildVillage() {
  ...
  return {
    ...
    h,
    warps: {
      "7,0": { map: "route", x: 7, y: 16, dir: "up" },
      "8,0": { map: "route", x: 8, y: 16, dir: "up" },
    },
    signs: {
      "10,11":
        "“PIMPLEIA, beneath Olympus — birthplace of Orpheus. The Grove Road runs north. Beware the tall grass.”",
    },
    encounters: null,
    npcs: [
      {
      ...
      },
      {
        ...
        kind: "heal",
        talk: [
          "<b>Elder Myrrha</b>: “Orpheus. Even the cicadas hush when you pass — they are listening.”",
      ...
      },
      {
        ...
        kind: "npc",
        talk: [
          "<b>Child</b>: “There's a stranger at the north gate with wings on his SHOES. Mama says don't stare at gods, but how can you not?”",
...
/* ================================================================
   ...
   roads waits at Pimpleia's gate with three companions: Brontlet /
   Calfin / Kilnclaw (the chart's one true triangle:
...
async function hermesGift(npc) {
  if (state.team.length > 0) {
    await owSay(
      "<b>Hermes</b>: “Still here? Roads, singer. They're the whole point of me.”",
    );
    return;
  }
  await owSay([
...
function buildRoute() {
  ...
  borderOf(g, "T");
  g[17][7] = ",";
  g[17][8] = ","; // south road gap (to village)
  for (let y = 1; y <= 16; y++) {
    g[y][7] = ",";
    g[y][8] = ",";
  }
  ...
  return {
    ...
    h,
    warps: {
      "7,17": { map: "village", x: 7, y: 1, dir: "down" },
      "8,17": { map: "village", x: 8, y: 1, dir: "down" },
    },
    signs: {
      "8,0":
        "A sealed gate. “DELPHI — the way is barred. Return when the gods will it.”",
    },
    encounters: {
      min: 4,
      max: 7,
    ...
    npcs: [
      {
        ...
        team: ["pupnos", "slithra"],
        teamLv: [8, 9],
        onDefeat: openDelphiGate,
        talk: [
          "<b>Kass</b> blocks the road, amphorae at her belt.",
          "“The Cult of Typhon fears no lyre, singer. Show me your bond — or turn back.”",
        ],
        after: [
          "<b>Kass</b>: “…A true bond. Perhaps the Cult is wrong about your kind.”",
...
function buildDelphi() {
  ...
  return {
    name: "Delphi — Navel of the World",
    id: "delphi",
    grid: g,
    w,
    h,
    warps: {
      "9,15": { map: "route", x: 7, y: 1, dir: "down" },
      "10,15": { map: "route", x: 8, y: 1, dir: "down" },
    },
    signs: {
      "12,13":
        "“DELPHI — navel of the world. Tread softly: the god is in high temper today.”",
      "4,1":
        "“Behind the temple climbs the SACRED WAY — barred until the god's temper settles.”",
    },
    encounters: null,
    npcs: [
      {
      ...
      },
      {
        ...
        kind: "heal",
        talk: [
          "<b>Pythia</b>: “The god quarrels with Love upon his own doorstep. This will not end quietly.”",
      ...
      },
      {
        ...
        kind: "trainer",
        defeated: false,
        team: ["slithra", "seedviper"],
        teamLv: [10, 10],
        talk: [
          "<b>Acolyte</b>: “Pilgrims must be proven! The god's light tests all who walk this plaza.”",
        ],
        after: [
          "<b>Acolyte</b>: “Proven. Forgive me — since the serpent fell, we are all on edge.”",
        ],
      },
    ],
  };
...
function buildWorld() {
  return {
    ...
    route: buildRoute(),
    delphi: buildDelphi(),
    sacredWay: buildSacredWay(),
    athens: buildAthens(),
    coastRoad: buildCoastRoad(),
    corinth: buildCorinth(),
  };
}
let MAPS = buildWorld();
...
function resetWorld() {
  MAPS = buildWorld();
  if (typeof addChapter === "function") addChapter(MAPS);
}
...
function openSacredWay() {
  ...
  d.signs["4,1"] =
    "“Behind the temple climbs the SACRED WAY — to Cecropia and the lands of the east.”";
}
...
function openCoastRoad() {
  ...
  a.signs["12,16"] =
    "“The COAST ROAD — south along the Saronic shore, to Corinth of the two seas.”";
}
...
function buildSacredWay() {
  ...
  return {
    ...
    h,
    warps: {
      "1,13": { map: "delphi", x: 2, y: 1, dir: "down" },
      "2,13": { map: "delphi", x: 3, y: 1, dir: "down" },
      "23,6": { map: "athens", x: 1, y: 8, dir: "right" },
      "23,7": { map: "athens", x: 1, y: 9, dir: "right" },
    },
    signs: {
      "3,10":
        "“THE SACRED WAY — Delphi behind you, Cecropia ahead. Sing as you walk; the stones remember.”",
    },
    encounters: {
      min: 5,
      max: 9,
    ...
    npcs: [
      {
        ...
        dir: "up",
        sprite: "rhapsode",
        name: "Rhapsode Phemios",
        kind: "npc",
        talk: [
          "<b>Phemios</b> tunes a battered lyre. “A colleague! Do you know the oldest song, singer?”",
      ...
      },
      {
        ...
        teamLv: [10, 10],
        talk: [
          "<b>Iona</b>: “I walk to every shrine in Hellas. My companions have walked farther — show me yours!”",
        ],
        after: [
          "<b>Iona</b>: “Well fought. The road east runs to Cecropia — kings' city, still waiting for a god to claim it.”",
        ],
      },
    ],
  };
...
function buildAthens() {
  ...
  fillRect(g, 4, 12, 7, 14, "#");
  g[14][5] = "D";
  fillRect(g, 14, 12, 17, 14, "#");
  g[14][16] = "D";
  g[6][2] = "f";
  g[12][2] = "f";
  g[11][19] = "f";
  ...
  g[16][12] = "S";
  return {
    name: "Cecropia — the Unnamed City",
    id: "athens",
    grid: g,
    w,
    h,
    warps: {
      "0,8": { map: "sacredWay", x: 22, y: 6, dir: "left" },
      "0,9": { map: "sacredWay", x: 22, y: 7, dir: "left" },
    },
    signs: {
      "13,10":
        "“CECROPIA — the city has a king, but no god and no name. Two Olympians contend upon the rock.”",
      "12,16":
        "“The Coast Road to Corinth — closed while the city has no name.”",
    },
    encounters: null,
    npcs: [
      {
      ...
      },
      {
        ...
        dir: "down",
        sprite: "pythia",
        name: "Priestess Aglauros",
        kind: "heal",
        talk: [
          "<b>Aglauros</b>: “Two gods on one rock, and the king between them. Rest your beasts — the earth itself may shake.”",
        ],
      },
      {
        x: 8,
        ...
        dir: "right",
        sprite: "philosopher",
        name: "Philosopher Timon",
        kind: "trainer",
        defeated: false,
        team: ["owlet", "slithra"],
        teamLv: [12, 11],
        talk: [
          "<b>Timon</b>: “A premise: all beasts act from nature. A test: whose nature is stronger — yours or mine?”",
        ],
        after: [
          "<b>Timon</b>: “Conclusion: yours. I shall revise my premises.”",
        ],
      },
      {
        x: 15,
        ...
        kind: "npc",
        talk: [
          "<b>Citizen</b>: “The king stands on the acropolis between the two gods. Whatever he decides, half the city will grumble.”",
        ],
      },
    ],
  };
...
function buildCoastRoad() {
  ...
  return {
    ...
    h,
    warps: {
      "7,0": { map: "athens", x: 10, y: 16, dir: "up" },
      "8,0": { map: "athens", x: 11, y: 16, dir: "up" },
      "7,19": { map: "corinth", x: 9, y: 1, dir: "down" },
      "8,19": { map: "corinth", x: 10, y: 1, dir: "down" },
    },
    signs: {
      "5,2":
        "“COAST ROAD — the Saronic glitters east. Corinth of the two seas lies south.”",
    },
    encounters: {
      min: 8,
      max: 11,
    ...
    npcs: [
      {
        ...
        teamLv: [12, 12],
        talk: [
          "<b>Drakon</b> plants his spear across the road. “None pass to Corinth unproven. Phalanx — forward!”",
        ],
        after: [
          "<b>Drakon</b>: “You'd have made a fine shield-mate. Pass — and mind the harbor crowds.”",
        ],
      },
      {
        x: 11,
        ...
        teamLv: [13],
        talk: [
          "<b>Halios</b>: “The sea gives and the sea takes. Today it gives you a fight!”",
        ],
        after: [
          "<b>Halios</b>: “Hah! Fair catch. May the Sea-lord mind your sails, singer.”",
        ],
      },
    ],
  };
...
function buildCorinth() {
  ...
  g[3][7] = "f";
  return {
    name: "Corinth — Mistress of Two Seas",
    id: "corinth",
    grid: g,
    w,
    h,
    warps: {
      "9,0": { map: "coastRoad", x: 7, y: 18, dir: "up" },
      "10,0": { map: "coastRoad", x: 8, y: 18, dir: "up" },
    },
    signs: {
      "4,9":
        "“CORINTH — mistress of two seas. Above you broods Acrocorinth, Aphrodite's mountain.”",
      "1,8":
        "“Road to Sparta — washed out by the spring floods. The engineers blame Poseidon; the engineers always blame Poseidon.”",
      "13,10":
        "“Harbor of Lechaion. Sailors swear a winged shadow crosses the moon on clear nights.”",
    },
    encounters: null,
    npcs: [
      {
        ...
        dir: "down",
        sprite: "priestessA",
        name: "Priestess of Aphrodite",
        kind: "heal",
        talk: [
          "<b>Priestess</b>: “From Acrocorinth the Lady watches every harbor and every heart.”",
      ...
      },
      {
        ...
        kind: "npc",
        talk: [
          "<b>Bellerophon</b> stares into the fountain of Pirene, a coil of golden rope in his lap.",
      ...
      },
      {
        ...
        kind: "npc",
        talk: [
          "<b>Merchant</b>: “Two seas, two harbors, one toll road between — everything crosses Corinth, friend, including trouble.”",
        ],
      },
      {
        x: 11,
        ...
        teamLv: [13, 12],
        talk: [
          "<b>Okypete</b>: “Fresh off the road? Harbor rule: new faces spar the bosun. In you go!”",
        ],
        after: [
          "<b>Okypete</b>: “You'd survive a squall, I'd wager. Welcome to Corinth.”",
        ],
      },
    ],
  };
...
async function mythAthens(npc) {
  ...
  if (st === 0) {
    ...
    $("ow-hint").textContent =
      "Poseidon has made his gift. Speak with Cecrops again…";
  } else if (st === 1) {
    await owSay([
    ...
    $("ow-hint").textContent =
      "Two gifts stand upon the rock. Cecrops must judge.";
  } else if (st === 2) {
    await owSay([
    ...
    if (state.ow.map === M) {
      $("ow-place").textContent = M.name;
      $("brand-sub").textContent = M.name;
    }
    poseidon.dir = "down";
    openCoastRoad();
    state.ow.flags.athens = 3;
    $("ow-hint").textContent =
      "Myth II complete — Athens is named. The Coast Road lies open.";
  } else {
    await owSay(
      "<b>Cecrops</b>: “A spring of salt and a tree of silver — and my little rock chose well. Go gently on the roads, singer.”",
    );
  }
}
...
async function athenaLines() {
  ...
  if (st === 0)
    await owSay(
      "<b>Athena</b>: “The Earth-Shaker will strike first — he always strikes first. Watch what endures, singer, not what astonishes.”",
    );
  else if (st === 1)
    await owSay(
      "<b>Athena</b>: “My gift is planted. Now the king must weigh a wonder against a livelihood.”",
    );
  else if (st === 2)
    await owSay(
      "<b>Athena</b>: “Judgment sits heavy on half-serpent shoulders. Give him a moment.”",
    );
  else
    await owSay(
      "<b>Athena</b>: “Guard the tree, and the tree guards you. That is the whole treaty, and it has never been broken.”",
    );
}
...
async function poseidonLines() {
  ...
  if (st === 0)
    await owSay(
      "<b>Poseidon</b>: “Stand back from the rock, mortal. The sea is about to arrive.”",
    );
  else if (st < 3)
    await owSay(
      "<b>Poseidon</b>: “A puddle of oil against the whole grey ocean. Let the snake-king choose — and let him remember tides turn.”",
    );
  else
    await owSay(
      "<b>Poseidon</b>: “…Keep your olive city. But every one of her ships will still ask <i>my</i> leave.” The god almost smiles. Almost.",
    );
}

/* Book I scripts and world additions live in chapter.js. */
