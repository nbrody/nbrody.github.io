export const exampleLibrary = [
    {
        ...
        mats: [['\\sqrt{(1+\\sqrt{17-8\\cos(\\pi/2)})/2}+\\sqrt{(\\sqrt{17-8\\cos(\\pi/2)}-1)/2}', '0', '0', '1/(\\sqrt{(1+\\sqrt{17-8\\cos(\\pi/2)})/2}+\\sqrt{(\\sqrt{17-8\\cos(\\pi/2)}-1)/2})'],
        ['- e^{i\\pi/4} \\frac{\\sqrt{3-\\sqrt{17-8\\cos(\\pi/2)}/2} + i\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}+1}}{2\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}-2}}', '-(1 + (\\frac{\\sqrt{3-\\sqrt{17-8\\cos(\\pi/2)}/2} + i\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}+1}}{2\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}-2}})^2)', '1', 'e^{-i\\pi/4} \\frac{\\sqrt{3-\\sqrt{17-8\\cos(\\pi/2)}/2} + i\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}+1}}{2\\sqrt{\\sqrt{17-8\\cos(\\pi/2)}-2}}']]
    },
    {
