...
const vec3 SPHERE_POS1 = vec3(1.0, 1.0, 0.0);
const vec3 SPHERE_POS2 = vec3(1.0, -1.0, 0.0);
const vec3 SPHERE_POS3 = vec3(-1.0, 1.0, 0.0);
const vec3 SPHERE_POS4 = vec3(-1.0, -1.0, 0.0);
const vec3 SPHERE_POS5 = vec3(1.0 + sqrt(3.), 0.0, 0.0);
const vec3 SPHERE_POS6 = vec3(-1.0 - sqrt(3.), 0.0, 0.0);
const vec3 SPHERE_POS7 = vec3(0.0, 0.0, 1.4142);
const vec3 SPHERE_POS8 = vec3(0.0, 0.0, -1.4142);
