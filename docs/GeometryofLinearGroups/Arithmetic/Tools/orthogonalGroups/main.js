...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Quaternion algebra buttons
    document.getElementById('show-quaternion-intro').addEventListener('click', function() {
        showQuaternionIntro();
    });

    document.getElementById('find-quaternion-units').addEventListener('click', function() {
        findQuaternionUnits();
    });

    document.getElementById('analyze-quaternion-generators').addEventListener('click', function() {
        analyzeQuaternionGenerators();
    });
