...
# --- Configuration ---
BEAM_WIDTH = 1000
MAX_ITERATIONS = 200   # Number of frames/iterations to show
T_PARAM = fmpz(9)
...
if __name__ == "__main__":
    # 1. Randomness = 0
    create_animation(0.0, 'beam_search_r0_small.mp4')
    
    # 2. Randomness = 0.2
    create_animation(0.2, 'beam_search_r02_small.mp4')
    
    # 3. Randomness = 1.0 (Every word is random)
    create_animation(1.0, 'beam_search_r1_small.mp4')
